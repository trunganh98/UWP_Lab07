...
namespace U41
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        public MainPage()
        {
            ...
            Contacts.Add(new Contact { FirstName = "Nguyen", LastName = "Trung Anh", AvatarPath = "Assets/male-01.png" });
            Contacts.Add(new Contact { FirstName = "Tran", LastName = "Dang Hai", AvatarPath = "Assets/female-01.png" });
